        ...
        <div className="blog-card row col-12">
          ...
          <div className="blog-card-body">
            ...
            <p className="description text-muted">
              ...
              است. چه به دنبال یک چت‌بات هوش مصنوعی باشید، چه یک تولید کننده
              محتوا یا ابزاری برای پردازش داده‌ها، Qwen 2.5 طیف وسیعی از
              ویژگی‌ها را ارائه می‌دهد. توی این پست میخوام Qwen 2.5 و سابقه اش
              رو بررسی کنم .
            </p>
        ...
        <div className="blog-card row col-12">
          ...
          <div className="blog-card-body">
            ...
            <p className="description text-muted">
              ...
              های قدرت مندی مثل Chat-gpt و Open AI عملکرد بهتری داشته . توی این
              پست میخوام درباره این AI عجیب بیشتر صحبت کنم .
            </p>
            <div className="footer-card">
              <div className="profile-container">
                <img src={profile} alt="Abbas" className="profile" />
